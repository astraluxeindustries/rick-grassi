            ...
            <div className="space-y-6">
              ...
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <a href="mailto:rgrassi@majormtg.net" className="text-lg font-semibold text-slate-900 hover:text-blue-700 transition-colors">
                    rgrassi@majormtg.net
                  </a>
                </div>
              </div>
